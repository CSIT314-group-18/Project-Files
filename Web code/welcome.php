...
if($getuserInfoSqlStmt = mysqli_prepare($link, $getuserInfoSql)){
	...
	if(mysqli_stmt_execute($getuserInfoSqlStmt)){
		...
		while(mysqli_stmt_fetch($getuserInfoSqlStmt)){
			...
			$userAccountArea .= "<h3>" . $fname . " " . $lname . "</h3><ul style='list-style-type:none'><li style='border: 2px solid grey;width:25%;'>Your Balance is $" . $balance . "<br></li>
			...
			<li>' . $facebook . '&nbsp;&nbsp;&nbsp;<br><button class="btn" onclick="showChanger(' . "'fbChange'," . $users_id . ')">Update Social Media Link</button>
